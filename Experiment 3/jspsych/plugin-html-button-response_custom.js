var jsPsychHtmlButtonResponseCustom = (function (jspsych) {
  'use strict';
  ...
  class HtmlButtonResponsePlugin {
      ...
      trial(display_element, trial) {
          // display stimulus
          var html = '<div id="jspsych-html-button-response-stimulus" style="margin: 0 auto; width:75%; text-align:left">' + trial.stimulus + "</div>";
          //display buttons
          var buttons = [];

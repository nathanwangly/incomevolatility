...
stimulus: function() {
  ...
  '<p><li>After the practice rounds, you will be given the opportunity to play the game twice.</li></p>' +
  '<p><li>Finally, you will be asked to provide some information about yourself and your financial situation.</li></ul></p>' +
  '<br><p>The experiment should take about 30 minutes to complete. If you have any questions or issues during or after the experiment, please contact Nathan Wang-Ly (<a href="mailto:nathan.wang-ly@unsw.edu.au">nathan.wang-ly@unsw.edu.au</a>).</p>' +

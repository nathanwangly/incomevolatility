var jsPsychSurveySpendSave = (function (jspsych) {
  'use strict';

  const info = {
      name: "survey-spendsave",
      parameters: {
          questions: {
  ...
  class SurveyTextPlugin {
      ...
      trial(display_element, trial) {
          ...
          for (var i = 0; i < trial.questions.length; i++) {
              ...
              if (question.rows == 1) {
                  html +=
                      `<input type="number" min="0" max="${savings}" style="text-align:center;" id="input-` +
                          question_index +
          ...
          // show remaining savings
          html += '<p id="remainder">Remaining savings: £' + savings.toLocaleString('en-AU') + '</p>'
          ...
          // update remaining savings in real-time
            ...
            function setupUpdater(){
                ...
                function handleChange(){
                    var replacement_remainder = null;
                    ...
                    set (remainder, 'Remaining savings: £' + replacement_remainder.toLocaleString('en-AU'));
                }

var jsPsychSurveyMultiChoiceCustom = (function (jspsych) {
  'use strict';
  ...
  class SurveyMultiChoicePlugin {
      ...
      trial(display_element, trial) {
          ...
          if (trial.autocomplete) {
              html += '<form id="jspsych-survey-multi-choice-form" style="margin:0 auto; max-width:35%">';
          }
          else {
              html += '<form id="jspsych-survey-multi-choice-form" style="margin:0 auto; max-width:35%" autocomplete="off">';
          }
